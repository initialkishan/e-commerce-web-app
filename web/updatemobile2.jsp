<%-- 
    Document   : updatemobile2
    Created on : Jun 28, 2019, 11:59:11 AM
    Author     : admin
--%>
...
<%
	...
	try{
		...
		rs=st.executeQuery("select * from mobile2");	
		while(rs.next())
		{
                                                    int uid=rs.getInt(1);
			%>
			...
			<td><% out.print(rs.getString(6)); %></td>
                        <td><a href="testmobile2.jsp?id=<%=uid%>"> Upload Photo</a></td>
                        <td><a href="edit.jsp?id=<%=uid%>"><span class="glyphicon glyphicon-pencil" /></a></td>
        <td><a href="deletemobile2.jsp?m=<%=uid%>"><span class="glyphicon glyphicon-remove" /></a></td>
