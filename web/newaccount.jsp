...
function ajaxres(str)
{
	...
	xmlhttp.open("GET","logres.jsp?pw="+str,true);
	xmlhttp.send();
}
...
<tr>
    ...
    <option value = "+1">Bahamas, The +1</option>
    ...
    <option value = "+1">Dominica, Commonwealth of +1</option>
    ...
    <option value = "+284">Seychelles +248</option>
    ...
    <option value = "+263">Zimbabwe +263</option>
     ...
     Email (optional)<br>
		...
		<input type = "password" name = "password" onkeyup="ajaxres(this.value)" placeholder = "At least 6 characters" required /><div id="dynText"></div>
		<br><i>Password must be 6 characters.</i><br>
		<input type = "submit" class="btn btn-warning btn-lg btn-block" name = "submitregistration" value = "Create Account" />
...
if(request.getParameter("submitregistration")!=null)
{
   // try
	...
	try{
		...
		String sql="insert into account1 values('"+firstname+"','"+middlename+"','"+lastname+"','"+mobilenumber+"','"+password+"',"+cc+")";
		...
		{
			out.println("Acount Not Created");
		}
