<%-- 
    Document   : updatemobile3
    Created on : Jun 28, 2019, 12:00:14 PM
    Author     : admin
--%>
...
<%
	...
	try{
		...
		rs=st.executeQuery("select * from mobile3");	
		while(rs.next())
		{
                                                    int uid=rs.getInt(1);
			%>
			...
			<td><% out.print(rs.getString(6)); %></td>
                        <td><a href="testmobile3.jsp?id=<%=uid%>"> Upload Photo</a></td>
                        <td><a href="edit.jsp?id=<%=uid%>"><span class="glyphicon glyphicon-pencil" /></a></td>
        <td><a href="deletemobile3.jsp?m=<%=uid%>"><span class="glyphicon glyphicon-remove" /></a></td>
