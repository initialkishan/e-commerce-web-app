<%-- 
    Document   : insertmobile2
    Created on : Jun 28, 2019, 11:20:57 AM
    Author     : admin
--%>
...
if(request.getParameter("b1")!=null)
{
	...
	try{
		...
		String sql="insert into mobile2(product_id,brand_name,price,discount,offerprice,detail) values("+gid+",'"+name+"',"+price+","+d+","+offerprice+",'"+detail+"')";
